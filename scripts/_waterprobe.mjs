...
if (amp !== null || dir !== null) {
  await page.evaluate(({ amp, dir }) => { const c = window.__lagoon.controls(); if (amp !== null) c.swellAmplitude = amp; if (dir !== null) c.swellDirection = dir; c.apply(); }, { amp, dir });
  await page.waitForTimeout(4000);
}
for (const wait of [500, 400, 400, 400, 400, 400, 400, 400]) {
  await page.waitForTimeout(wait);
  const p = await page.evaluate(() => window.__lagoon.simProbe());
