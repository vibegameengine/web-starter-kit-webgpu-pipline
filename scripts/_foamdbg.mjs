...
console.log(JSON.stringify(await page.evaluate(() => window.__lagoon.foamDebug())));
console.log(await page.evaluate(async () => { try { return JSON.stringify(await window.__lagoon.foamStats()); } catch (e) { return 'ERR ' + (e.stack || e); } }));
await browser.close();
