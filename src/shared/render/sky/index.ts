export { SkyAtmosphere, DEFAULT_SKY_SETTINGS, type SkyAtmosphereSettings } from './skyAtmosphere.ts';
export { earthAtmosphere, type AtmosphereParameters } from './atmosphereParameters.ts';
