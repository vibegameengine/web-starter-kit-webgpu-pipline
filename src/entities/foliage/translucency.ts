 ...
 *
 * The beach foliage no longer uses this: `leafMaterial.ts` transmits light inside
 * the lighting model, with the sun's shadow. This stays for anything else that
 * still reads it.
 */
